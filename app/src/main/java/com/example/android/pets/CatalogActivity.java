...
public class CatalogActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                // if the items with ID 2 was clicked on.
    ...
    private void insertPet() {
        ...
        // and Tony items attributes are the values.
        ContentValues values = new ContentValues();
        values.put(itemEntry.COLUMN_ITEM_NAME, "Tony");
        ...
        // Receive the new content URI that will allow us to access Tony's Item data in the future.
